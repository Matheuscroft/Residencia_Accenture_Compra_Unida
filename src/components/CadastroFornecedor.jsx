                        ...
                        <Card.Body>
                            ...
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Form.Group controlId="cnpj_mei" className="mb-3">
                                    <Form.Label className="text-light">CPNJ/MEI: OBG</Form.Label>
                                    <Form.Control type="text" name="cnpj_mei" value={dadosFornecedor.cnpj_mei || ""} onChange={handleChange} placeholder="CPF/CPNJ" required />
                                    {errors.cnpj_mei && <Alert variant="danger">{errors.cnpj_mei}</Alert>}
                                </Form.Group>

                                <Form.Group controlId="endereco" className="mb-3">
                                    <Form.Label className="text-light">Endereço: OBG</Form.Label>
                                ...
                                <Form.Group controlId="telefone" className="mb-3">
                                    <Form.Label className="text-light">Telefone: OBG</Form.Label>
                                ...
                                <Form.Group controlId="email" className="mb-3">
                                    <Form.Label className="text-light">E-mail: OBG</Form.Label>
                                ...
                                <Form.Group controlId="senha" className="mb-3">
                                    <Form.Label className="text-light">Senha: OBG</Form.Label>
                                ...
                                <Form.Group controlId="confirma_senha" className="mb-3">
                                    <Form.Label className="text-light">Confirma Senha: OBG</Form.Label>
